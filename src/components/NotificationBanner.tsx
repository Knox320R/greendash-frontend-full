                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="flex-1">
                                            <div className={`text-base font-semibold ${
                                                ...
                                                {item.status === "approved"
                                                    ? t('notificationBanner.withdrawalApproved', { amount: item.amount })
                                                    : t('notificationBanner.withdrawalReturned', { amount: item.amount })
                                                }
                                            </div>
                                            <div className="text-sm text-gray-700 mt-1 font-medium">
                                                {item.status === "approved"
                                                    ? t('notificationBanner.approvedMessage')
                                                    : t('notificationBanner.returnedMessage')
                                                }
                                            </div>
                                        </div>
                                    </div>
